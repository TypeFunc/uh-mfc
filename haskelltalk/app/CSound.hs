...
wave :: Sig -> Sig
wave x = oscBy (weierstrassTab 2 7 1000) x

{- Evaluate the expression below in ghci.  It will open up a virtual keyboard where you can hear what the weierstrass function sounds like. :) To close it, press Ctrl-C twice to return to ghci. -}
